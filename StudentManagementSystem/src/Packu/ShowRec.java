 ...
 * @author Unique
 */
public class ShowRec extends javax.swing.JFrame {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ShowRec.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
