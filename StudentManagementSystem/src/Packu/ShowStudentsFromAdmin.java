 ...
 * @author Unique
 */
public class ShowStudentsFromAdmin extends javax.swing.JFrame {

    Connection con = null;
    ResultSet rs = null;
    Statement stmt = null;
    public ShowStudentsFromAdmin() {
        initComponents();
    ...
    private void initComponents() {
        ...
        jButton1.setIcon(new javax.swing.ImageIcon("C:\\Users\\Poudel\\Downloads\\left-arrow.png")); // NOI18N
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ShowStudentsFromAdmin.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new ShowStudentsFromAdmin().setVisible(true);
            }
        });
    }
